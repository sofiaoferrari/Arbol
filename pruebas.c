...
void pruebas_de_abb_con_4_elementos() {    
   ...
   // pa2m_afirmar(arbol_insertar(abb, pesar_manzana(7)) == EXITO, "Inserto el elemento 7");  
    ...
    pa2m_afirmar(arbol_borrar(abb, pesar_manzana(6)) == EXITO, "Se pudo borrar el elemento 6");
    

    pa2m_afirmar(arbol_borrar(abb, pesar_manzana(3)) == EXITO, "Se pudo borrar el elemento 3");
